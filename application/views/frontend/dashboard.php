  ...
  <div id="home" class="slider-area">
    <div class="bend niceties preview-2">
      <div id="ensign-nivoslider" class="slides">
        <img src="<?php echo base_url('frontend/img/slider/banner keripik 1.jpg') ?>" alt="" title="#slider-direction-1" />
        <img src="<?php echo base_url('frontend/img/slider/banner keripik 2.jpg') ?>" alt="" title="#slider-direction-2" />
        <img src="<?php echo base_url('frontend/img/slider/banner keripik 3.jpg') ?>" alt="" title="#slider-direction-3" />
      </div>
      <!-- direction 1 -->
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-left">
            <div class="single-well">
              <a href="#">
								  <img src="<?php echo base_url('frontend/img/about/1.jpg') ?>" alt="">
								</a>
            </div>
          </div>
        </div>
        ...
        <div class="team-top">
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="<?php echo base_url('frontend/img/team/1.jpg') ?>" alt="">
									</a>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="<?php echo base_url('frontend/img/team/2.jpg') ?>" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="<?php echo base_url('frontend/img/team/3.jpg') ?>" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="<?php echo base_url('frontend/img/team/4.jpg') ?>" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
  ...
  <div class="reviews-area hidden-xs">
    <div class="work-us">
      <div class="work-left-text">
        <a href="#">
						<img src="<?php echo base_url('frontend/img/about/2.jpg') ?>" alt="">
					</a>
      </div>
      ...
      <div class="row">
        ...
        <div class="awesome-project-content">
          <!-- single-awesome-project start -->
            <?php foreach($portofolio as $pro) : ?>
          <div class="col-md-4 col-sm-4 col-xs-12 design development">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="<?php echo base_url('backend/img/' . $pro->gambar1) ?>" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?php echo base_url('backend/img/thumb/' . $pro->gambar1) ?>">
                      <h4><?php echo $pro->nama_produk ?></h4>
                      <span><?php echo $pro->kategori ?></span>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div class="single-blog">
              ...
              <div class="blog-meta">
                <span class="comments-type">
									...
									<a href="#"><?= $pro->kategori ?></a>
								</span>
                <span class="date-type">
									<i class="fa fa-calendar"></i><?= $pro->tanggal ?>
								</span>
              </div>
              <div class="blog-text">
                <h4>
                  <a href="blog.html"><?= $pro->nama_produk ?></a>
								</h4>
              </div>
              <span>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs=12">
          <div class="suscribe-text text-center">
            <h3>Selamat Datang Di Nusantara Chips</h3>
            <a class="sus-btn" href="#">Dapatkan penawaran</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="contact-inner area-padding">
      ...
      <div class="container ">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <!-- Start Map -->
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3956.5045697607475!2d112.66656421432229!3d-7.409271075019784!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7e3b4dee97095%3A0xd1704872ddcba88b!2sJl.%20Durian%2012%2C%20Pekorungan%2C%20Pekarungan%2C%20Kec.%20Sukodono%2C%20Kabupaten%20Sidoarjo%2C%20Jawa%20Timur%2061258!5e0!3m2!1sid!2sid!4v1624380878748!5m2!1sid!2sid" width="100%" height="380" frameborder="0" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            <!-- End Map -->
          </div>
          <!-- End Google Map -->
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="form contact-form">
              ...
              <form action="<?php echo base_url('Dashboard/kontak'); ?>" method="post">
                <div class="form-group">
                  <input type="text" name="nama" class="form-control" value="<?php echo set_value('nama'); ?>" placeholder="Your Name" />
                ...
                <div class="form-group">
                  <textarea class="form-control" name="message" rows="5" value="<?php echo set_value('message'); ?>" placeholder="Message"></textarea>
