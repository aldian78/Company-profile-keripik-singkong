      ...
      <div data-active-color="white" data-background-color="crystal-clear" data-image="<?php echo base_url('backend/app-assets/img/sidebar-bg/08.jpg') ?>" class="app-sidebar">
        <div class="sidebar-header">
          <div class="logo clearfix"><a href="<?php echo base_url('admin/Dashboard'); ?>" class="logo-text float-left">
              <div class="logo-img"><img src="<?php echo base_url('backend/app-assets/img/logo.png') ?>" alt="Convex Logo"/></div><span class="text align-middle"><i>N Chips</i></span></a><a id="sidebarToggle" href="javascript:;" class="nav-toggle d-none d-sm-none d-md-none d-lg-block"><i data-toggle="expanded" class="ft-disc toggle-icon"></i></a><a id="sidebarClose" href="javascript:;" class="nav-close d-block d-md-block d-lg-none d-xl-none"><i class="ft-circle"></i></a></div>
        </div>
